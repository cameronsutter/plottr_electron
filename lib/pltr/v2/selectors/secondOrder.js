...
import { isDarkModeSelector, previouslyLoggedIntoProSelector } from './settingsFirstOrder'
...
import { orientationSelector, timelineIsExpandedSelector } from './timelineThirdOrder'
...
export const pinnedPlotlinesSelector = createSelector(timelineSelector, (timeline) => {
