...
export const cantShowFileSelector = createSelector(
  ...
  isResumingSelector,
  isOfflineSelector,
  (fileLoaded, hasActiveProSubscription, selectedFileIsACloudFile, isResuming, isOffline) => {
    return (
      !isResuming &&
      (!fileLoaded || isOffline || !!hasActiveProSubscription !== !!selectedFileIsACloudFile)
    )
  }
)
