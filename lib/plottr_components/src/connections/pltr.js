...
const pltrTypeSpecs = {
  ...
  publishRCEOperations: PropTypes.func.isRequired,
  fetchRCEOperations: PropTypes.func.isRequired,
  listenForChangesToEditor: PropTypes.func.isRequired,
  deleteChangeSignal: PropTypes.func.isRequired,
  deleteOldChanges: PropTypes.func.isRequired,
