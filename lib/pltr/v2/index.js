...
import * as secondOrderSelectors from './selectors/secondOrder'
import * as charactersThirdOrderSelectors from './selectors/charactersSecondOrder'
import * as customAttributesThirdOrderSelectors from './selectors/customAttributesThirdOrder'
import * as knownFilesThirdOrderSelectors from './selectors/knownFilesThirdOrder'
import * as notesThirdOrderSelectors from './selectors/notesThirdOrder'
import * as placesThirdOrderSelectors from './selectors/placesThirdOrder'
import * as tagsThirdOrderSelectors from './selectors/tagsThirdOrder'
import * as templatesThirdOrderSelectors from './selectors/templatesThirdOrder'
import * as timelineThirdOrderSelectors from './selectors/timelineThirdOrder'
import * as uiThirdOrderSelectors from './selectors/uiThirdOrder'
...
const selectors = {
  ...
  ...attributesSelectors,
  ...secondOrderSelectors,
  ...charactersThirdOrderSelectors,
  ...customAttributesThirdOrderSelectors,
  ...knownFilesThirdOrderSelectors,
  ...notesThirdOrderSelectors,
  ...placesThirdOrderSelectors,
  ...tagsThirdOrderSelectors,
  ...templatesThirdOrderSelectors,
  ...timelineThirdOrderSelectors,
  ...uiThirdOrderSelectors,
}
