...
export const secondTierBeatsInAtLeastTwoTierArrangementSelector = createSelector(
  ...
  (hierarchyLevels, sortedBeats, beats) => {
    ...
    // I think that I need to insert beat place holders here.
    // The condition:
    //  - Current beat is at the right level.
    //  - Current beat has a parent beat.
    //  - The prior beat of the parent has no children.
    //
