...
const ProInfoConnector = (connector) => {
  ...
  checkDependencies({ logOut, checkForPro, useSettingsInfo, appQuit })

  const ProInfo = ({ emailAddress, hasCurrentProLicense }) => {
