...
import { cloneDeep, keys, values, findLast } from 'lodash'
        ...
        return content.children.flatMap((childContent) => {
          ...
          if (childContent.text) {
            if (
              ...
              return {
                lineId: existingPlotline && existingPlotline.id ? existingPlotline.id : nextLineId,
              }
            } else {
