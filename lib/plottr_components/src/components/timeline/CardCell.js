...
const CardCellConnector = (connector) => {
  ...
  class CardCell extends Component {
    ...
    handleDragStart = (e) => {
      ...
      e.dataTransfer.setData('text/json', JSON.stringify({ cards: this.props.cards }))
    }

    handleDragEnd = () => {
      this.setState({ dragging: false })
      console.log('dragging end :(', this.state.dragging)
    }

    handleDragEnter = (e) => {
      console.log('dragging enter', this.state.dragging)
    ...
    handleDragLeave = (e) => {
      console.log('dropDepth', this.state.dropDepth)
    ...
    handleDrop = (e, cardIndex) => {
      ...
      if (droppedData.cards) {
        this.moveCard(droppedData.cards)
      } else if (droppedData.cardId && cardIndex) {
        this.moveCard(droppedData.cardId, cardIndex)
      }
      return
    }
          ...
          <div key={card.id}>
            <ErrorBoundary>
              <Card
                ...
                handleDrop={(e) => this.handleDrop(e, idx)}
