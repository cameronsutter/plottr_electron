...
export function draggingOverBeat(beatId) {
  return { type: DRAGGING_OVER_BEAT, beatId }
}

export function pickUpBeat(beatId) {
  return { type: BEAT_PICKED_UP, beatId }
}

export function hoverOverBeat(beatId) {
  return { type: HOVERING_OVER_BEAT, beatId }
}
