...
export const ACTS_TOUR_STEPS = [
    ...
    },
    {
      ...
      content:'You can remove levels of hierarchy, but BE CAREFUL as the cards within that chapter or act may be deleted. Once you decide to go with multiple levels of hierarchy, we recommend sticking with at least as many as you choose to add. Pro-tip: you can always hit \'undo.\'',
      event:'hover',
      spotlightClicks: true,
      disableBeacon:true,
    },
    ...
    },
    {
      ...
      content:'Click to the right of higher level cards to add another of that card (e.g. another act). If you just now implemented acts for this project there is only one act (level 3) and/or one chapter (level 2) containing all of your cards. Added acts and chapters show up at the end of the timeline.',
      event:'hover',
      spotlightClicks: true,
      placement:'right',
      styles: {
