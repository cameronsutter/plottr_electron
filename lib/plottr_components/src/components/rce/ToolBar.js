      ...
      <div className={cx('slate-editor__toolbar-wrapper', { darkmode: darkMode })} ref={toolbarRef}>
        <ButtonToolbar>
          <ButtonGroup>
            ...
            <MarkButton mark="bold" icon={<FaBold />} editor={editor} />
            <MarkButton mark="italic" icon={<FaItalic />} editor={editor} />
            <MarkButton mark="underline" icon={<FaUnderline />} editor={editor} />
            <MarkButton mark="strike" icon={<FaStrikethrough />} editor={editor} />
