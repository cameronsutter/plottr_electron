  ...
  switch (action.type) {
    ...
    case PIN_PLOTLINE: {
      return {
        ...
        timeline: {
          ...state.timeline,
          pinnedPlotlines: !state.timeline.pinnedPlotlines ? 1 : state.timeline.pinnedPlotlines + 1,
        },
      }
    }
    ...
    case UNPIN_PLOTLINE: {
      return {
        ...
        timeline: {
          ...state.timeline,
          pinnedPlotlines: !state.timeline.pinnedPlotlines ? 0 : state.timeline.pinnedPlotlines - 1,
        },
      }
    }
