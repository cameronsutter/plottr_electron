...
import {
  ...
  isSeriesSelector,
  draggingOverBeatSelector,
  pickedUpBeatSelector,
} from './ui'
import {
  maxDepth,
  nextId,
...
export const showInsertGuideSelector = createSelector(
  beatIdSelector,
  pickedUpBeatSelector,
  draggingOverBeatSelector,
  beatsByBookSelector,
  (beatId, beatPickedUp, beatDraggedOver, beats) => {
    return (
      beatId ===
      (beatPickedUp &&
        beatDraggedOver &&
        idOfBeatBeforeWhenReordered(beats, beatPickedUp, beatDraggedOver))
    )
  }
)

export const beatIsDraggedOverSelector = createSelector(
  beatIdSelector,
  draggingOverBeatSelector,
  (beatId, draggedBeat) => beatId === draggedBeat
)
