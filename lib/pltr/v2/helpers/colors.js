...
const defaultDarkModeBackgroundColour = '#666'
const defaultBackgroundColour = 'hsl(212, 33%, 89%)'

export const getBackgroundColor = (isDarkMode) => {
  return isDarkMode ? defaultDarkModeBackgroundColour : defaultBackgroundColour
}
