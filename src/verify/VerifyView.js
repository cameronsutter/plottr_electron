  ...
  render () {
    return (
      <div>
        ...
        <p className='text-muted'><small>(If not, please contact me @ <a href='mailto:cameronsutter0@gmail.com'>cameronsutter0@gmail.com</a> or @camsutter on Twitter)</small></p>
