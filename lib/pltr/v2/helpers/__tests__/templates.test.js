...
describe('applyTemplate', () => {
  ...
  describe('given a file with three levels', () => {
    ...
    describe('and a template with three levels', () => {
      ...
      //   })
      //   it('should have the plotlines that were there originally', () => {
      //     expect(result.lines).toEqual(expect.arrayContaining(file_with_three_levels.lines))
      //   })
      //   it('should insert cards on the plotlines from the template', () => {
      //     const templateLines = result.lines
      //       .map((line) => {
      //         return line.id
      //       })
      //       .filter((lineId) => {
      //         return (
      //           file_with_three_levels.lines
      //             .map((line) => {
      //               return line.id
      //             })
      //             .indexOf(lineId) === -1
      ...
      //       })
      //     const addedCards = result.cards.filter((card) => {
      //       return templateLines.indexOf(card.lineId) !== -1
      //     })
      //     const templateCards = three_level_biased_middle_plotline_template.templateData.cards
      //     expect(templateCards.length).toEqual(addedCards.length)
      //     expect(addedCards.map(withoutLineBeatOrCardIds)).toEqual(
      //       expect.arrayContaining(templateCards.map(withoutLineBeatOrCardIds))
      //     )
      ...
      //       return templateLines.indexOf(card.lineId) !== -1
      //     })
      //     const templateCards = three_level_biased_bottom_plotline_template.templateData.cards
      //     expect(templateCards.length).toEqual(addedCards.length)
      //     expect(addedCards.map(withoutLineBeatOrCardIds)).toEqual(
      //       expect.arrayContaining(templateCards.map(withoutLineBeatOrCardIds))
      //     )
