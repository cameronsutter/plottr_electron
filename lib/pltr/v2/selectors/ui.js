...
export const cardDialogCardIdSelector = (state) => state.ui.cardDialog?.cardId
export const cardDialogLineIdSelector = (state) => state.ui.cardDialog?.lineId
export const cardDialogBeatIdSelector = (state) => state.ui.cardDialog?.beatId
export const cardDialogVisibilitySelector = (state) => state.ui.cardDialog?.isOpen
