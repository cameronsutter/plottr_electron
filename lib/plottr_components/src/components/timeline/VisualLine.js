...
export default function VisualLine({ color, orientation, isMedium, tableLength, offset }) {
  ...
  let translation = orientation == 'vertical' ? isMedium ? `translate(${offset-25}px,0)` : `translate(${offset}px,0)` : `translate(0,${offset}px)`
