import { ADD_CHARACTER_ATTRIBUTE, ADD_PLACES_ATTRIBUTE, ADD_CARDS_ATTRIBUTE, ADD_LINES_ATTRIBUTE,
  ADD_SCENES_ATTRIBUTE, EDIT_SCENES_ATTRIBUTE, REMOVE_CHARACTER_ATTRIBUTE,
  REMOVE_PLACES_ATTRIBUTE, REMOVE_CARDS_ATTRIBUTE, REMOVE_LINES_ATTRIBUTE,
...
export function editSceneAttr (index, oldAttribute, newAttribute) {
  return { type: EDIT_SCENES_ATTRIBUTE, index, oldAttribute, newAttribute}
}
