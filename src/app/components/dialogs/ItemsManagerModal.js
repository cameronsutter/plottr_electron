...
export default function ItemsManagerModal({
  ...
  return (
    <PlottrModal
        ...
        style={modalStyles}
      >
        <div className={cx('custom-attributes__wrapper', { darkmode: darkMode })}>
          <Button className='pull-right' onClick={closeDialog}>
            {i18n('Close')}
          </Button>
          {showSaveAsTemplate ?
            <Button className='pull-right character-list__custom-attributes__save-as-template' onClick={saveAsTemplate}>
