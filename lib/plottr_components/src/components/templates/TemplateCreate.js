...
import UnconnectedToolTip from '../ToolTip'
...
const TemplateCreateConnector = (connector) => {
  const ToolTip = UnconnectedToolTip(connector)
                  ...
                  <Row>
                    ...
                    <Col sm={8}>
                      <label className="template-create__bias-label">
                        ...
                        <ToolTip text="If the template's levels differ from the plotlines, Plottr resolves the conflict using this control.">
                          <FiHelpCircle />
                        </ToolTip>
                      </label>
                    </Col>
