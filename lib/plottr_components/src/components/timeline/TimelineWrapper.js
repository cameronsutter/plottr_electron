...
const TimelineWrapperConnector = (connector) => {
  ...
  TimelineWrapper.propTypes = {
    ...
    cardDialogVisibility: PropTypes.bool,
  }
    ...
    return connect(
      (state) => {
        return {
          ...
          cardDialogVisibility: selectors.cardDialogVisibilitySelector(state.present),
        }
      },
      (dispatch) => {
        return {
