        ...
        describe('and child beat id 4', () => {
          describe('and the parent beat id 7', () => {
            it('should move the beat from book 1 into book 2 as a child of beat 7', () => {
              ...
              const newTimelineState = timelineReducer(threeLevelHierarchyState, action)
              const timelineForBook1 = newTimelineState.hierarchy.find(
                ({ bookId }) => bookId === '1'
              )
              const timelineForBook2 = newTimelineState.hierarchy.find(
                ({ bookId }) => bookId === '2'
              )
              const timelineForBookSeries = newTimelineState.hierarchy.find(
                ({ bookId }) => bookId === 'series'
              ...
              expect(timelineForBook1).toEqual({
                ...threeLevelHierarchyState[0],
                hierarchy: [
                  {
                    ...threeLevelHierarchyState[0].hierarchy[0],
                    children: [threeLevelHierarchyState[0].hierarchy[0].children[1]],
                  },
                ],
              })
              expect(timelineForBookSeries).toEqual(threeLevelHierarchyState[1])
                ...
                hierarchy: [
                  {
                    ...threeLevelHierarchyState[0].hierarchy[0],
                    children: [
                      threeLevelHierarchyState[0].hierarchy[0].children[0],
                      {
                        ...threeLevelHierarchyState[0].hierarchy[0].children[1],
                        children: [
                          {
                            level: 1,
                            beatId: 4,
