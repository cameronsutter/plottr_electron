...
const modalStyles = { content: { width: '50%', marginLeft: '25%', minHeight: 200 } }
const confirmModalStyles = { content: { width: '50%', marginLeft: '25%', maxHeight: 320 } }
      ...
      if (stagedPlotlineTemplate) {
        ...
        return (
          <div onClick={stopPropogation} className="template-picker__dialog-wrapper">
            <div className="template-picker__dialog-wrapper--confirmation">
              <h1>{t('Confirm Placement')}</h1>
              <div className="template-picker__description">
                <p>The template you picked has a different act structure to your book.</p>
                <p>
                  The author of this template configured it to be aligned to your &quot;
                  {levelToApplyTo.name}&quot;
                </p>
              </div>
              <div className="template-picker__confirmation">
                <FormGroup>
                  <FormControl
