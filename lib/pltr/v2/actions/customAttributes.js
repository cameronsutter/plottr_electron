...
const escapeBraces = (attribute) => {
  if (attribute) {
    return {
      name: attribute.name.replace(/[{}]/g, ''),
      type: attribute.type,
    }
  }
  return attribute
...
export function addCharacterAttr(attribute) {
  return { type: ADD_CHARACTER_ATTRIBUTE, attribute: escapeBraces(attribute) }
}

export function removeCharacterAttr(attribute) {
  // attribute is the attr's name
  return { type: REMOVE_CHARACTER_ATTRIBUTE, attribute: escapeBraces(attribute) }
}
...
export function editCharacterAttr(index, oldAttribute, newAttribute) {
  return {
    ...
    index,
    oldAttribute: escapeBraces(oldAttribute),
    newAttribute: escapeBraces(newAttribute),
  }
}

export function addPlaceAttr(attribute) {
  return { type: ADD_PLACES_ATTRIBUTE, attribute: escapeBraces(attribute) }
}

export function removePlaceAttr(attribute) {
  // attribute is the attr's name
  return { type: REMOVE_PLACES_ATTRIBUTE, attribute: escapeBraces(attribute) }
}
...
export function addLineAttr(attribute) {
  return { type: ADD_LINES_ATTRIBUTE, attribute: escapeBraces(attribute) }
}

export function removeLineAttr(attribute) {
  return { type: REMOVE_LINES_ATTRIBUTE, attribute: escapeBraces(attribute) }
}

export function addCardAttr(attribute) {
  return { type: ADD_CARDS_ATTRIBUTE, attribute: escapeBraces(attribute) }
}
...
export function removeCardAttr(attribute) {
  return { type: REMOVE_CARDS_ATTRIBUTE, attribute: escapeBraces(attribute) }
}

export function reorderCardsAttribute(attribute, toIndex) {
  return { type: REORDER_CARDS_ATTRIBUTE, attribute: escapeBraces(attribute), toIndex }
}

export function reorderCharacterAttribute(attribute, toIndex) {
  return { type: REORDER_CHARACTER_ATTRIBUTE, attribute: escapeBraces(attribute), toIndex }
}

export function reorderPlacesAttribute(attribute, toIndex) {
  return { type: REORDER_PLACES_ATTRIBUTE, attribute: escapeBraces(attribute), toIndex }
}

export function addNoteAttr(attribute) {
  return { type: ADD_NOTES_ATTRIBUTE, attribute: escapeBraces(attribute) }
}
...
export function removeNoteAttr(attribute) {
  return { type: REMOVE_NOTES_ATTRIBUTE, attribute: escapeBraces(attribute) }
}

export function reorderNotesAttribute(attribute, toIndex) {
  return { type: REORDER_NOTES_ATTRIBUTE, attribute: escapeBraces(attribute), toIndex }
}
