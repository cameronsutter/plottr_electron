...
const BeatTitleCellConnector = (connector) => {
  class BeatTitleCell extends PureComponent {
    ...
    componentDidUpdate(prevProps, prevState) {
      console.log(`${this.props.beatId} changed:`)
      Object.entries(this.props).forEach(
        ([key, val]) =>
          prevProps[key] !== val &&
          console.log(` - ${this.props.beatId}: Prop '${key}' changed to ${val}`)
      )
      if (this.state) {
        Object.entries(this.state).forEach(
          ([key, val]) =>
            prevState[key] !== val &&
            console.log(` - ${this.props.beatId}: State '${key}' changed to ${val}`)
        )
      }
    }
        ...
        return (
          <Cell className="beat-table-cell">
            ...
            >
              ...
              {false && this.cellRef && this.props.showInsertGuide && (
                <VisualLine
                  disableAnimation
