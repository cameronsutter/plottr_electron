...
describe('startServer', (describe, it) => {
  it('should start, broadcast ports, have well-formed stores and ensure that various messages work', (success) => {
    try {
      ...
      return fs.promises
        .mkdtemp(
          path.join(baseTestDirectory, 'plottr_test_socket_server_userData')
          ...
          return startServer(
            ...
            return createClient(
              ...
              return new Promise((resolve) => setTimeout(resolve, 5000)).then(() => {
                ...
                // ==========Check the Stores==========
                return fs.promises.readFile(path.join(userDataDirectory, 'config.json')).then((configFile) => {
                      ...
                      return fs.promises.readFile(
                        ...
                        return fs.promises.readFile(
                          ...
                          return fs.promises.readFile(
                            ...
                            return fs.promises.readFile(path.join(userDataDirectory, 'templates.json')).then((templates) => {
                              console.log('[Server Integration Test]: Templates store exists...')
                              return fs.promises.readFile(path.join(userDataDirectory, 'trial_info.json')).then((trialInfo) => {
                                ...
                                return whenClientIsReady(({ setLastOpenedFilePath }) => {
                                  ...
                                  return fs.promises.readFile(
                                    ...
                                    return whenClientIsReady(({ nukeLastOpenedFileURL }) => {
                                      ...
                                      return new Promise((resolve) => setTimeout(resolve, 1000)).then(() => {
                                        return fs.promises.readFile(
                                          ...
                                          assertEqual(parsedLastOpenedAfter, { lastOpenedFilePath: "" })
