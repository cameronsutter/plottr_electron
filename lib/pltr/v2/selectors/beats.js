...
const visibleBeatsByPositionForTimeline = (
  ...
  const activeParentId =
    timelineViewIsTabbed &&
    topLevelVisibleBeatsByPosition(beats, !timelineViewIsStacked && beatHierarchyIsOn)[activeTab].id
  return visibleBeatsForTopLevelParentByPosition(
    beats,
    beatHierarchyIsOn && !timelineViewIsStacked,
    timelineViewIsTabbed,
    activeParentId
  )
}
...
export const timelineSparceBeatMap = createSelector(
  ...
  (beats, beatHierarchyIsOn, timelineViewIsTabbed, activeTab, timelineViewIsStacked) => {
    const activeParentId =
      timelineViewIsTabbed &&
      topLevelVisibleBeatsByPosition(beats, !timelineViewIsStacked && beatHierarchyIsOn)[activeTab]
        .id

    return visibleBeatsForTopLevelParentByPosition(
      beats,
      !timelineViewIsStacked && beatHierarchyIsOn,
      timelineViewIsTabbed,
      activeParentId
