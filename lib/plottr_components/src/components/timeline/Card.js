...
const CardConnector = (connector) => {
  ...
  class Card extends Component {
    ...
    renderTitle() {
      const { card, isSmall, orientation, beatPosition, linePosition } = this.props
      let titleStyle = {}
