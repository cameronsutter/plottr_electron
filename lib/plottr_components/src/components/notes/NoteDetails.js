      ...
      return (
        <div className="note-list__note-wrapper">
          <div className="note-list__note" onClick={this.props.startEditing}>
            <h4 className="secondary-text">{note.name || i18n('New Note')}</h4>
            <div className="note-list__note-notes">
              <div>
                <Image size="large" shape="circle" imageId={note.imageId} />
                ...
                <dl className="dl-horizontal">
                  <dt>{i18n('Notes')}</dt>
                  <dd>
                    <RichText description={note.notes} darkMode={ui.darkMode} />
                  </dd>
                </dl>
                {templateNotes}
              </div>
