...
export const newFileSeriesTimeline = {
  ...seriesTimeline,
  hierarchy: [{ level: 0, beatIds: newFileBeats.map(({ beatId }) => beatId), children: [] }],
}

export const newFileTimeline = {
  ...bookTimeline,
  hierarchy: [{ level: 0, beatIds: newFileChapters.map(({ beatId }) => beatId), children: [] }],
}

export const newFileTimelines = [newFileSeriesTimeline, newFileTimeline]
