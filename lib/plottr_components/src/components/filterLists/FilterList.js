...
const FilterListConnector = (connector) => {
  ...
  if (redux) {
    ...
    const {
      pltr: {
        selectors: { charactersFilterItems, placesFilterItems, tagsFilterItems },
      },
    } = connector
    checkDependencies({
      charactersFilterItems,
      placesFilterItems,
      tagsFilterItems,
    })
    ...
    return connect((state) => {
      return {
        characters: charactersFilterItems(state.present),
        places: placesFilterItems(state.present),
        tags: tagsFilterItems(state.present),
