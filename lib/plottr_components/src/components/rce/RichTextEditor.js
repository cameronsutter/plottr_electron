...
const RichTextEditorConnector = (connector) => {
  ...
  const RichTextEditor = ({ ...props }) => {
    ...
    const handleKeyDown = (event) => {
      ...
      // TODO: need to rethink this a bit
      // right now it scrolls to the end after every key stroke
      // we only want it to scroll if the cursor is on the last line
      // scrollToEnd()
    }
          ...
          >
            <ToolBar wrapperRef={toolbarRef}>
              <ButtonGroup>
                ...
                />
                <FontSizeChooser darkMode={props.darkMode} />
