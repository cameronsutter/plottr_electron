...
export const getTextColor = (color, isDarkMode, isActStructureOn) => {
  if (color !== 'none' && isActStructureOn) return color

  return isDarkMode && !isActStructureOn ? defaultDarkModeText : defaultLightModeText
}
