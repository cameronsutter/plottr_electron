...
const ui =
  ...
  (state = defaultUI, action) => {
    let filter
    if (action.currentlyShouldBeLoggedIn && !action.currentUserId && action.currentPermission !== 'owner') {
      return state
    }
    if (action.currentlyShouldBeLoggedIn && action.currentUserId) {
      ...
      if (action.permission === 'owner') {
        return updateUI(state, action)
      } else if (action.permission === 'collaborator') {
        ...
        if (collaboratorExists) {
          return {
            ...
            collaborators: {
              ...
              collaborators: state.collaborators.collaborators.map((collaboratorUI) => {
                if (collaboratorUI.uid === action.currentUserId) {
          ...
          return {
            ...
            collaborators: {
              ...state.collaborators,
              collaborators: [...state.collaborators.collaborators, updateUI(omit(state, 'collaborators'), action)]
            }
          }
        }
      } else if (action.permission === 'viewer') {
        ...
        if (collaboratorExists) {
          ...
          return {
            ...
            collaborators: {
              ...state.collaborators,
              viewers: [...state.collaborators.viewers, updateUI(omit(state, 'collaborators'), action)]
            }
          }
        }
      } else {
