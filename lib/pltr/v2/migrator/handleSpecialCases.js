...
export const handleMissingTemplatesFieldOnCards = (file) => {
  ...
  return {
    ...
    file: {
      ...clone(file.file),
      appliedMigrations: [...file.file.appliedMigrations, 'm2021.7.27'],
    },
...
const applyAllFixes = (file) => [handle2021_07_07, handleMissingTemplatesFieldOnCards].reduce((acc, f) => f(acc), file)
