            ...
            <Col sm={9}>
              <div className="item-list__book-tabs-wrapper">
                ...
                >
                  ...
                  <Tab eventKey={1} title={t('Book 1')}></Tab>
                  <Tab eventKey={2} title={t('2')}></Tab>
                  <Tab eventKey={2} title={t('3')}></Tab>
                  <Tab eventKey={2} title={t('4')}></Tab>
                  <Tab eventKey={2} title={t('5')}></Tab>
                  <Tab eventKey={2} title={t('6')}></Tab>
                  <Tab eventKey={2} title={t('7')}></Tab>
                  <Tab eventKey={2} title={t('8')}></Tab>
                  <Tab eventKey={2} title={t('9')}></Tab>
                  <Tab eventKey={2} title={t('10')}></Tab>
                  <Tab eventKey={2} title={t('10')}></Tab>
                  <Tab eventKey={2} title={t('10')}></Tab>
                  <Tab eventKey={2} title={t('10')}></Tab>
                  <Tab eventKey={2} title={t('10')}></Tab>
