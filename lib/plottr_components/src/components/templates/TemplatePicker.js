...
const TemplatePickerConnector = (connector) => {
  ...
  const TemplatePicker = ({
    ...
    useEffect(() => {
      ...
      type.forEach((type) => {
        newTemplates[type] = listTemplates(type)
        newCustomTemplates = [...newCustomTemplates, ...listCustomTemplates(type)]
      })
    ...
    const deleteTemplate = (e) => {
      ...
      setCustomTemplates(type.flatMap(listCustomTemplates))
      setDeleting(false)
      setDeleteWhich(null)
    }
    ...
    const saveTemplateEdit = (data) => {
      ...
      const newCustomTemplates = type.flatMap((type) => listCustomTemplates(type))
      setEditing(false)
      setCustomTemplates(newCustomTemplates)
    }
