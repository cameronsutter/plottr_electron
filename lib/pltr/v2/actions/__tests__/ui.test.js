    ...
    describe('and openNewBookDialog is dispatched', () => {
      ...
      describe('given addBook is dispatched with completely blank fields', () => {
        ...
        it('should work as before and save the book without passing any params', () => {
          ...
          const filteredBook = Object.keys(book).filter((b) => !!book[b])
          expect(filteredBook.title).toBeUndefined()
          expect(filteredBook.theme).toBeUndefined()
          expect(filteredBook.title).toBeUndefined()
          expect(filteredBook.title).toBeUndefined()
        })
      })
      ...
      describe('given addBook is dispatched with id and attributes', () => {
        ...
        it('should save the book with its attributes', () => {
          ...
          const filteredKey = Object.keys(book).filter((b) => {
            return !!book[b]
          })
          expect(book[filteredKey].title).toEqual(exampleBookAttributes.title)
          expect(book[filteredKey].theme).toEqual(exampleBookAttributes.theme)
          expect(book[filteredKey].genre).toEqual(exampleBookAttributes.genre)
          expect(book[filteredKey].premise).toEqual(exampleBookAttributes.premise)
        })
      })
    ...
    describe('given openEditBookDialog is dispatched', () => {
      ...
      describe('given editBook is dispatched with id and attributes', () => {
        ...
        it('should edit the book with the new values', () => {
          ...
          expect(book[filteredKey].title).toEqual(newTitle)
          expect(book[filteredKey].theme).toEqual(exampleBookAttributes.theme)
          expect(book[filteredKey].genre).toEqual(exampleBookAttributes.genre)
          expect(book[filteredKey].premise).toEqual(exampleBookAttributes.premise)
        })
