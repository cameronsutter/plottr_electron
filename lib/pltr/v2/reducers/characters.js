            ...
            return {
              ...
              attributes: {
                ...
                [action.bookId]: attributeExists
                  ...
                  : [...bookAttributes, { id: action.attributeId, value: action.value }],
              },
            }
          }
      ...
      case EDIT_CHARACTER_ATTRIBUTE_METADATA: {
        ...
        return state.map((character) => {
          ...
          return {
            ...
            attributes: {
              ...attributes,
              [action.bookId]: bookAttributes.map((attribute) => {
      ...
      case DELETE_CHARACTER_ATTRIBUTE: {
        return state.map((character) => {
          ...
          return {
            ...
            attributes: {
              ...attributes,
              [action.bookId]: bookAttributes.filter((attribute) => {
