...
const database = () => {
  ...
  if (process.env.NEXT_PUBLIC_NODE_ENV === 'development') {
    try {
      ...
      initializeFirestore({ ignoreUndefinedProperties: true, host: 'plottr.local:8081', ssl: true })
      _database = getFirestore(firebaseApp)
    ...
    initializeFirestore({ ignoreUndefinedProperties: true })
    _database = getFirestore(firebaseApp)
  }
  return {
    instance: _database,
