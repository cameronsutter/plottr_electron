  ...
  describe('given a file with one level', () => {
    describe('and a template with one level', () => {
      describe('and the template is biased to the "top"', () => {
        ...
        it('should insert cards on the plotlines from the template', () => {
          const templateLines = one_level_biased_top_plotline_template.templateData.lines.map(
            (line) => {
              return line.id
            }
          )
      ...
      describe('and the template is biased to the "middle"', () => {
        ...
        it('should insert cards on the plotlines from the template', () => {
          const templateLines = one_level_biased_middle_plotline_template.templateData.lines.map(
            (line) => {
              return line.id
            }
          )
      ...
      describe('and the template is biased to the "bottom"', () => {
        ...
        it('should insert cards on the plotlines from the template', () => {
          const templateLines = one_level_biased_bottom_plotline_template.templateData.lines.map(
            (line) => {
              return line.id
            }
          )
    ...
    describe('and a template with two levels', () => {
      describe('and the template is biased to the "top"', () => {
        ...
        it('should insert cards on the plotlines from the template', () => {
          const templateLines = two_level_biased_top_plotline_template.templateData.lines.map(
            (line) => {
              return line.id
            }
          )
      ...
      describe('and the template is biased to the middle', () => {
        ...
        it('should insert cards on the plotlines from the template', () => {
          const templateLines = two_level_biased_middle_plotline_template.templateData.lines.map(
            (line) => {
              return line.id
            }
          )
      ...
      describe('and the template is biased to the bottom', () => {
        ...
        it('should insert cards on the plotlines from the template', () => {
          const templateLines = two_level_biased_bottom_plotline_template.templateData.lines.map(
            (line) => {
              return line.id
            }
          )
    ...
    describe('and a template with three levels', () => {
      describe('and the template is biased to the top', () => {
        ...
        it('should insert cards on the plotlines from the template', () => {
          const templateLines = three_level_biased_top_plotline_template.templateData.lines.map(
            (line) => {
              return line.id
            }
          )
      ...
      describe('and the template is biased to the middle', () => {
        ...
        it('should insert cards on the plotlines from the template', () => {
          const templateLines = three_level_biased_middle_plotline_template.templateData.lines.map(
            (line) => {
              return line.id
            }
          )
    ...
    describe('and a template with one level', () => {
      ...
      describe('and the template is biased to the "bottom"', () => {
        ...
        it('should insert cards on the plotlines from the template', () => {
          ...
          const addedCards = result.cards.filter((card) => {
            return templateLines.indexOf(card.id) !== -1
          })
