...
const withoutLineId = x => omit(x, 'lineId')
  ...
  describe('given a file with one level', () => {
    describe('and a template with one level', () => {
      describe('and the template is biased to the "top"', () => {
        ...
        it('should have the cards in the template', () => {
          expect(result.cards).toEqual(
            expect.arrayContaining(one_level_biased_top_plotline_template.templateData.cards)
          )
        })
        ...
        it('should add the plotlines from the template', () => {
          expect(result.lines).toEqual(
            expect.arrayContaining(one_level_biased_top_plotline_template.templateData.lines)
          )
        })
        ...
        it('should insert cards on the plotlines from the template', () => {
          ...
          expect(addedCards.map(withoutLineId)).toEqual(
            expect.arrayContaining(
              one_level_biased_top_plotline_template.templateData.cards.map(withoutLineId)
            )
          )
        })
      })
      describe('and the template is biased to the "middle"', () => {
        ...
        it('should have the cards in the template', () => {
          expect(result.cards).toEqual(
            expect.arrayContaining(one_level_biased_middle_plotline_template.templateData.cards)
          )
        })
        it('should have at least as many beats as the template', () => {
          const templateNumberOfBeats = beatsLength(
        ...
        it('should add the plotlines from the template', () => {
          expect(result.lines).toEqual(
            expect.arrayContaining(one_level_biased_middle_plotline_template.templateData.lines)
          )
        })
        it('should have the plotlines that were there originally', () => {
          expect(result.lines).toEqual(expect.arrayContaining(file_with_one_level.lines))
        ...
        it('should insert cards on the plotlines from the template', () => {
          ...
          expect(addedCards.map(withoutLineId)).toEqual(
            expect.arrayContaining(
              one_level_biased_middle_plotline_template.templateData.cards.map(withoutLineId)
            )
          )
        })
      })
      describe('and the template is biased to the "bottom"', () => {
        ...
        it('should have the cards in the template', () => {
          expect(result.cards).toEqual(
            expect.arrayContaining(one_level_biased_bottom_plotline_template.templateData.cards)
          )
        })
        it('should have at least as many beats as the template', () => {
          const templateNumberOfBeats = beatsLength(
        ...
        it('should add the plotlines from the template', () => {
          expect(result.lines).toEqual(
            expect.arrayContaining(one_level_biased_bottom_plotline_template.templateData.lines)
          )
        })
        it('should have the plotlines that were there originally', () => {
          expect(result.lines).toEqual(expect.arrayContaining(file_with_one_level.lines))
        ...
        it('should insert cards on the plotlines from the template', () => {
          ...
          expect(addedCards.map(withoutLineId)).toEqual(
            expect.arrayContaining(one_level_biased_bottom_plotline_template.templateData.cards.map(withoutLineId))
          )
        })
      })
    })
    describe('and a template with two levels', () => {
      describe('and the template is biased to the "top"', () => {
        ...
        it('should have the cards in the template', () => {
          ...
          const cardsInBookFromTemplate = result.cards.filter((card) => {
            return topLevelBeatIds.indexOf(card.beatId) !== -1
          })
          expect(result.cards).toEqual(expect.arrayContaining(cardsInBookFromTemplate))
        })
        ...
        it('should add the plotlines from the template', () => {
          expect(result.lines).toEqual(
            expect.arrayContaining(two_level_biased_top_plotline_template.templateData.lines)
          )
        })
        it('should have the plotlines that were there originally', () => {
          expect(result.lines).toEqual(expect.arrayContaining(file_with_one_level.lines))
        ...
        it('should insert cards on the plotlines from the template', () => {
          ...
          expect(two_level_biased_top_plotline_template.templateData.cards.length).toEqual(
            addedCards.length
          )
          expect(addedCards.map(withoutLineId)).toEqual(expect.arrayContaining(templateCards.map(withoutLineId)))
        })
      })
      describe('and the template is biased to the middle', () => {
        const result = applyTemplate(
        ...
        it('should add the plotlines from the template', () => {
          expect(result.lines).toEqual(
            expect.arrayContaining(two_level_biased_middle_plotline_template.templateData.lines)
          )
        })
        it('should have the plotlines that were there originally', () => {
          expect(result.lines).toEqual(expect.arrayContaining(file_with_one_level.lines))
        ...
        it('should insert cards on the plotlines from the template', () => {
          ...
          expect(two_level_biased_middle_plotline_template.templateData.cards.length).toEqual(
            addedCards.length
          )
          expect(addedCards.map(withoutLineId)).toEqual(expect.arrayContaining(templateCards.map(withoutLineId)))
        })
      ...
      describe('and the template is biased to the bottom', () => {
        ...
        it('should add the plotlines from the template', () => {
          expect(result.lines).toEqual(
            expect.arrayContaining(two_level_biased_bottom_plotline_template.templateData.lines)
          )
        })
        it('should have the plotlines that were there originally', () => {
          expect(result.lines).toEqual(expect.arrayContaining(file_with_one_level.lines))
        ...
        it('should insert cards on the plotlines from the template', () => {
          ...
          expect(two_level_biased_bottom_plotline_template.templateData.cards.length).toEqual(
            addedCards.length
          )
          expect(addedCards.map(withoutLineId)).toEqual(expect.arrayContaining(templateCards.map(withoutLineId)))
        })
    ...
    describe('and a template with three levels', () => {
      describe('and the template is biased to the top', () => {
        ...
        it('should add the plotlines from the template', () => {
          expect(result.lines).toEqual(
            expect.arrayContaining(three_level_biased_top_plotline_template.templateData.lines)
          )
        })
        it('should have the plotlines that were there originally', () => {
          expect(result.lines).toEqual(expect.arrayContaining(file_with_one_level.lines))
        ...
        it('should insert cards on the plotlines from the template', () => {
          ...
          expect(three_level_biased_top_plotline_template.templateData.cards.length).toEqual(
            addedCards.length
          )
          expect(addedCards.map(withoutLineId)).toEqual(expect.arrayContaining(templateCards.map(withoutLineId)))
        })
      ...
      describe('and the template is biased to the middle', () => {
        ...
        const middleLevelBeats = topLevelBeats.flatMap((beat) => {
        ...
        it('should add the plotlines from the template', () => {
          expect(result.lines).toEqual(
            expect.arrayContaining(three_level_biased_middle_plotline_template.templateData.lines)
          )
        })
        it('should have the plotlines that were there originally', () => {
          expect(result.lines).toEqual(expect.arrayContaining(file_with_one_level.lines))
        ...
        it('should insert cards on the plotlines from the template', () => {
          ...
          expect(three_level_biased_middle_plotline_template.templateData.cards.length).toEqual(
            addedCards.length
          )
          expect(addedCards.map(withoutLineId)).toEqual(expect.arrayContaining(templateCards.map(withoutLineId)))
        })
      ...
      describe('and the template is biased to the bottom', () => {
        ...
        const bottomLevelBeats = middleLevelBeats.flatMap((beat) => {
          return tree.children(result.beats['1'], beat.id)
        })
        it('should have more cards', () => {
          expect(result.cards.length).toBeGreaterThanOrEqual(file_with_one_level.cards)
        })
        it('should have the cards it used to have', () => {
          expect(result.cards).toEqual(expect.arrayContaining(file_with_one_level.cards))
        })
        it('should have the cards in the template', () => {
          ...
          const cardsInBookFromTemplate = result.cards.filter(({ beatId }) => {
            return bottomLevelBeatIds.indexOf(beatId) !== -1
          })
          expect(result.cards).toEqual(expect.arrayContaining(cardsInBookFromTemplate))
        })
        ...
        it('should add the plotlines from the template', () => {
          expect(result.lines).toEqual(
            expect.araryContaining(three_level_biased_bottom_plotline_template)
          )
        })
        it('should have the plotlines that were there originally', () => {
          expect(result.lines).toEqual(expect.arrayContaining(file_with_one_level.lines))
        ...
        it('should insert cards on teh plotlines from the template', () => {
          const templateLines = three_level_biased_bottom_plotline_template.templateData.lines.map(
            (line) => {
              return line.id
            }
          )
          ...
          expect(three_level_biased_bottom_plotline_template.templateData.cards.length).toEqual(
            addedCards.length
          )
          expect(addedCards.map(withoutLineId)).toEqual(
            expect.arrayContaining(three_level_biased_bottom_plotline_template.templateData.cards.map(withoutLineId))
          )
        })
      })
    })
  ...
  describe('given a file with two levels', () => {
    describe('and a template with one level', () => {
      ...
      describe('and the template is biased to the "bottom"', () => {
        ...
        const templateBeats = tree.children(file_with_two_levels.templateData.beats['1'], null)
        it('should have more cards', () => {
          expect(result.cards.length).toBeGreaterThanOrEqual(file_with_two_levels.cards.length)
        })
        it('should have the cards it used to have', () => {
        ...
        it('should have the cards in the template', () => {
          expect(result.cards).toEqual(
            expect.araryContaining(one_level_biased_bottom_plotline_template.templateData.cards)
          )
        })
        it('should have the plotlines that were there originally', () => {
          expect(result.lines).toEqual(expect.arrayContaining(file_with_two_levels.lines))
    ...
    describe('and a template with two levels', () => {
      describe('and the template is biased to the "top"', () => {
        ...
        const templateBottomBeats = templateTopBeats.flatMap((beat) => {
          return tree.children(templateTopBeats.templateData.beats['1'], beat.id)
        })
      ...
      describe('and the template is biased to the bottom', () => {
        ...
        const templateBottomBeats = templateTopBeats.flatMap((beat) => {
          return tree.children(two_level_biased_bottom_plotline_template.beats['1'], beat.id)
        })
        const resultTopBeats = tree.children(result.beats['1'], null)
        const resultBottomBeats = resultTopBeats.flatMap((beat) => {
          return tree.children(file_with_two_levels.beats['1'], beat.id)
        })
        it('should have more cards', () => {
          expect(result.cards.length).toBeGreaterThanOrEqual(file_with_two_levels.cards.length)
        })
        ...
        it('should have the cards in the template', () => {
          expect(result.cards).toEqual(
            expect.arrayContaining(two_level_biased_bottom_plotline_template.cards)
          )
        })
        it('should have at least as many beats as the template at the top level', () => {
          const templateNumberOfBeats = templateTopBeats.length
        ...
        it('should have the plotlines that were there originally', () => {
          expect(result.lines).toEqual(
            expect.arrayContaining(two_level_biased_bottom_plotline_template.lines)
          )
        })
        it('should insert cards on the plotlines from the template', () => {
          const templateLines = result.lines
    ...
    describe('and a template with three levels', () => {
      describe('and the template is biased to the top', () => {
        ...
        it('should have the cards it used to have', () => {
          expect(result.cards).toEqual(
            expect.arrayContaining(file_with_two_levels.cards)
          )
        })
        it('should have at least as many beats as the template at the top level', () => {
          const templateNumberOfBeats = templateTopBeats.length
        ...
        it('should have the plotlines that were there originally', () => {
          expect(result.lines).toEqual(
            expect.arrayContaining(three_level_biased_top_plotline_template.lines)
          )
        })
        it('should insert cards on the plotlines from the template', () => {
          const templateLines = result.lines
      ...
      describe('and the template is biased to the middle', () => {
        ...
        it('should have at least as many beats as the template in the middle', () => {
          const templateNumberOfBeats = templateMiddleBeats.length
          const resultNumberOfBeats = resultBottomBeats.leangth
          expect(resultNumberOfBeats).toBeGreaterThanOrEqual(templateNumberOfBeats)
        })
        it('should have the plotlines that were there originally', () => {
          expect(result.lines).toEqual(expect.arrayContaining(file_with_two_levels.lines))
