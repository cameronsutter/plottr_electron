...
const BookListConnector = (connector) => {
  ...
  class BookList extends Component {
    ...
    renderBookDialog = () => {
      const { bookDialogBookId, bookDialogBookNumber, isBookDialogVisible } = this.props

      if (!isBookDialogVisible) return false

      return (
        <BookDialog
          bookId={bookDialogBookId}
          bookNumber={bookDialogBookNumber}
          modal={true}
          cancel={this.handleCloseBookDialog}
        />
      )
    }
