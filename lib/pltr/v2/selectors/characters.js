...
import { characterAttributesPerBookSelector } from './attributes'
...
export const characterAttributesSelector = createSelector(
  characterAttributesPerBookSelector,
  characterCustomAttributes,
  (attributesPerBook, customAttributes) => {
    return [...attributesPerBook, ...customAttributes]
  }
)
