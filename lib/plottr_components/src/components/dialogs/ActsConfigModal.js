...
const ActsConfigModalConnector = (connector) => {
  ...
  const ActsConfigModal = ({
    ...
    const viewByFlag = gatedByBeatHierarchy(featureFlags)
    ...
    const RemoveLevelConfirmation = () =>
      stagedHierarchyLevels ? (
        <DeleteConfirmModal
          customText={t(
            "Are you sure? Removing a level will delete the timeline cards directly under this level's heading cards (from all books across the project)."
          )}
          onDelete={() => {
                  ...
                  <div className="acts-modal__timeline-view-controls">
                    ...
                    <div className="acts-modal__timeline-view-dropdown">
                      ...
                      >
                        ...
                        <MenuItem key={'tabbed'} onSelect={() => setTimelineView('tabbed')}>
