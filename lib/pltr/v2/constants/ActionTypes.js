...
export const IMPORT_SCRIVENER = 'IMPORT_SCRIVENER'
...
export const LICENSE_ACTIONS = [SET_TRIAL_INFO, SET_LICENSE_INFO]
...
export const SETTINGS_ACTIONS = [SET_EXPORT_SETTINGS, SET_USER_SETTINGS, SET_APP_SETTINGS]
