...
const FilesHomeConnector = (connector) => {
  ...
  checkDependencies({ createNew, createFromSnowflake, log, dialog, showOpenDialogSync, mpq })
  ...
  const FilesHome = (props) => {
    ...
    const createFomSnowflakeImport = () => {
    ...
    return (
      <div className="dashboard__files">
        <NewFiles
          ...
          doSnowflakeImport={createFomSnowflakeImport}
        />
        {body}
      </div>
    )
