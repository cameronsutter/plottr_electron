...
export const showBookTabsSelector = createSelector(allCharactersSelector, (characters) => {
...
export const displayedSingleCharacterSelector = createSelector(
  ...
  (character, bookId, currentBookAttributeDescirptorsById) => {
    ...
    const tags = currentBookAttributes.find((attribute) => {
      return (
    ...
    const description = currentBookAttributes.find((attribute) => {
      return (
        currentBookAttributeDescirptorsById[attribute.id].type === 'base-attribute' &&
    ...
    const notes = currentBookAttributes.find((attribute) => {
      return (
        currentBookAttributeDescirptorsById[attribute.id].type === 'base-attribute' &&
